...
import com.example.basicweather.placeholder.PlaceholderContent.PlaceholderItem
 ...
 */
class MyDailyForecastRecyclerViewAdapter(
    private val values: List<DailyForecasts>
) : RecyclerView.Adapter<MyDailyForecastRecyclerViewAdapter.ViewHolder>() {
